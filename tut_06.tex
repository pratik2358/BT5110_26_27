...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{tut_06_images/example_1_sq_0.pdf}
    % \caption{Caption}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{tut_06_images/example_1_sq_1.pdf}
    % \caption{Caption}
    % \label{fig:placeholder}
\end{figure}    
\end{frame}
\begin{frame}{Some ideas}
    \begin{figure}
        \centering
        \includegraphics[width=0.95\linewidth]{tut_06_images/example_1_sq_2.pdf}
        % \caption{Caption}
        % \label{fig:placeholder}
    \end{figure}
\end{frame}
